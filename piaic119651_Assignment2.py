...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.array([arr[0],arr[0],arr[0],arr[1],arr[1],arr[1],arr[2],arr[2],arr[2],arr[1],arr[2],arr[3],arr[1],arr[2],arr[3],arr[1],arr[2],arr[3]])
...
def function13():
    ...
    ans =  np.array([x for x in arr if x>5 and x<10]) 
    return ans
...
def function16():
    ...
    for i in range(0,len(x)):
        ans.append(np.array([[x[i][0],y[i][0]]]))
    ans=np.array(ans)
    return ans
...
def function20():
    ...
    return np.array([abc(i) for i in x]) 
